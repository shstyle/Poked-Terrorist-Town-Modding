...
public void OnPluginStart()
{
	...
	g_iHurtPrio = Config_LoadInt("hurt_sort_prio", 0, "The sorting priority of the Hurt Station in the shop menu.");1	`
	...
	g_iHealthCharges = Config_LoadInt("health_station_ch arges", 10, "The amount of charges that the health station should start off with.");
